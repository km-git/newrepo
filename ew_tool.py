...
def main() -> None:
  ...
  parser.add_argument(
    "--monitor",
    action="store_true",
    help="Serve browser monitor dashboard (http://127.0.0.1:8765 — /monitor, /monetize, /dmarc, /tape-to-cloud, /sspm)",
  )
  ...
  parser.add_argument(
    "--static",
    action="store_true",
    help="With --monetize-ui, --sspm-ui, or --dmarc-ui: write self-contained HTML and print a file:// path (no server)",
  )
  parser.add_argument(
    "--sspm-ui",
    action="store_true",
