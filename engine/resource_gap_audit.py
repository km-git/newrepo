...
WATCHLIST: Tuple[Dict[str, Any], ...] = (
  ...
  {"id": "binance_funding", "category": "free_data", "impact": "high",
   "integrated_in": "gateway/web_intel.py", "challenge": "Funding has HTTP 451 fallback — is OKX/Bybit funding wired?"},
  ...
  {"id": "open_interest", "category": "free_data", "impact": "high",
   "integrated_in": None, "challenge": "Missing OI + liquidation heatmaps — are we blind to crowded trades?"},
  ...
  {"id": "tv_market_structure", "category": "tv_oss", "impact": "high",
   "integrated_in": None, "challenge": "BOS/CHoCH (ICT) not ported — does EW structure miss smart-money shifts?"},
