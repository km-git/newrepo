...
from engine.monetization_strategy import (
  build_monetization_strategy,
  save_monetization_strategy,
)
...
def test_cli_monetize_outputs_json(tmp_path, monkeypatch):
  ...
  assert out.exists()
  assert "[monetize] saved monetization strategy" in proc.stderr
